...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  var _editedProduct = Product(id: '', title: '', description: '', price: 0, imageUrl: 'imageUrl');
  var _initValues = {
    'title': '',
    'description': '',
    'price': '',
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: _imageUrlController.text.isEmpty ? const Text('Enter a URL') : FittedBox(fit: BoxFit.cover,child: Image.network(_imageUrlController.text),),
                  ),
                  Expanded(
                    child: TextFormField(
